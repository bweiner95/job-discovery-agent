...
function getDemoData() {
  ...
  const jobs = [
    ...
    { id: 1002, source: 'linkedin',   job_id: 'demo-2',  title: 'Head of Growth',                  company: 'Replit',     location: 'San Francisco, CA (Hybrid)', score: 9, score_reason: "Replit is high-growth consumer dev tool. Head of Growth title fits target list, SF hybrid. Strong brand and category leader.", salary: '$260K/yr', url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(0), status: 'active', also_on: ['ashby'] },
    { id: 1003, source: 'greenhouse', job_id: 'demo-3',  title: 'Senior Director, Strategy & Growth Initiatives', company: 'Chime', location: 'San Francisco, CA', score: 9, score_reason: "Consumer fintech, Senior Director at right level for ~8y experience. Exact target function. SF on-site is acceptable.", salary: '$295K/yr', url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(1), status: 'active', also_on: [] },
    { id: 1004, source: 'linkedin',   job_id: 'demo-4',  title: 'Head of C2C Activation, North America', company: 'eBay',    location: 'San Jose, CA (Hybrid)', score: 8, score_reason: "Top consumer marketplace, Head title, C2C marketplace growth scope. Bay Area Hybrid is workable.", salary: null,        url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(1), status: 'active', also_on: [] },
    { id: 1005, source: 'ashby',      job_id: 'demo-5',  title: 'Chief of Staff to CEO',           company: 'Linear',     location: 'Remote', score: 8, score_reason: "Linear is best-in-class dev tool, CoS to CEO at growth-stage, remote-friendly. Right level, strong brand, growth-strategy work.", salary: '$245K/yr', url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(2), status: 'active', also_on: ['alirohde'] },
    { id: 1006, source: 'linkedin',   job_id: 'demo-6',  title: 'Director, New Verticals Strategy & Operations', company: 'DoorDash', location: 'New York, NY (Hybrid)', score: 8, score_reason: "DoorDash is top consumer delivery, Director title at right level, NYC hybrid, S&O scope. Strong fit.", salary: null,         url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(2), status: 'active', also_on: [] },
    { id: 1007, source: 'greenhouse', job_id: 'demo-7',  title: 'Strategy & Operations Lead',     company: 'Discord',     location: 'New York, NY', score: 8, score_reason: "Discord is top consumer social, Lead title (Director-equivalent at consumer co with title compression), NYC.", salary: '$235K/yr', url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(3), status: 'active', also_on: [] },
    { id: 1008, source: 'lever',      job_id: 'demo-8',  title: 'Director of Product Growth',     company: 'Spotify',     location: 'New York, NY', score: 8, score_reason: "Spotify is iconic consumer brand. Director of Product Growth fits target function. NYC. Strong consumer subscription growth context.", salary: '$270K/yr', url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(3), status: 'active', also_on: [] },
    { id: 1009, source: 'alirohde',   job_id: 'demo-9',  title: 'Business Operations & Strategy Manager', company: 'Figma', location: 'San Francisco, CA (Hybrid)', score: 7, score_reason: "Figma is leading design tool with consumer-adjacent brand recognition. BizOps & Strategy at SF hybrid, Manager title fine for level.", salary: null,        url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(4), status: 'active', also_on: [] },
    { id: 1010, source: 'linkedin',   job_id: 'demo-10', title: 'Director, Strategic Initiatives, Digital Gaming', company: 'Mattel', location: 'El Segundo, CA', score: 7, score_reason: "Mattel is iconic consumer brand (toys/gaming/Barbie momentum), Director title, $195K listed (at floor). LA-acceptable on-site.", salary: '$195K', url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(4), status: 'active', also_on: [] },
    { id: 1011, source: 'ashby',      job_id: 'demo-11', title: 'Senior Manager, Business Operations',    company: 'Whatnot',   location: 'Los Angeles, CA · New York, NY · Remote', score: 7, score_reason: "Whatnot is top consumer livestream marketplace, multi-city US. Sr Manager fits level. Active S&O hiring at growth-stage.", salary: '$210K/yr', url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(5), status: 'active', also_on: ['linkedin'] },
    { id: 1012, source: 'linkedin',   job_id: 'demo-12', title: 'Manager, AV Strategy & Business Operations', company: 'Lyft',  location: 'San Francisco, CA (Hybrid)', score: 7, score_reason: "Lyft is consumer mobility brand, SF, AV is a strategic bet area. Manager title fine for ~8y if YOE/salary align.", salary: null,         url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(5), status: 'active', also_on: [] },
    { id: 1013, source: 'greenhouse', job_id: 'demo-13', title: 'Director, Strategy & Operations',         company: 'Pinterest', location: 'New York, NY (Hybrid)', score: 7, score_reason: "Pinterest is consumer social discovery, Director title, NYC hybrid. Right industry + level.", salary: null,         url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(6), status: 'active', also_on: [] },
    { id: 1014, source: 'alirohde',   job_id: 'demo-14', title: 'Chief of Staff',                  company: 'Cash App',     location: 'San Francisco, CA (Hybrid)', score: 7, score_reason: "Cash App (Block) is top consumer fintech, CoS title fits target, SF hybrid. Brand recognition + scale.", salary: null,         url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(6), status: 'active', also_on: [] },
    { id: 1015, source: 'lever',      job_id: 'demo-15', title: 'Head of Growth Marketing',         company: 'Hims & Hers',  location: 'New York, NY (Hybrid)', score: 7, score_reason: "Hims & Hers is consumer DTC health brand. Head of Growth Marketing scope is broad. NYC hybrid.", salary: '$250K/yr',  url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(7), status: 'active', also_on: [] },
  ];

  const appliedJobs = [
    { id: 2001, source: 'linkedin',   job_id: 'demo-a1', title: 'Director of Growth',              company: 'Webflow',    location: 'New York, NY (Hybrid)', score: 8, score_reason: "Strong fit.", salary: null, url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(8),  status: 'applied' },
    { id: 2002, source: 'ashby',      job_id: 'demo-a2', title: 'Strategy & Operations Lead',      company: 'Vercel',      location: 'San Francisco (Remote)', score: 8, score_reason: "Lead-level fit at consumer-adjacent dev tools.", salary: null, url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(10), status: 'applied' },
    { id: 2003, source: 'greenhouse', job_id: 'demo-a3', title: 'Senior Manager, Business Operations', company: 'Robinhood', location: 'New York, NY', score: 8, score_reason: "Consumer fintech + NYC + Sr Manager = strong.", salary: '$220K/yr', url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(12), status: 'applied' },
  ];

  const notFitJobs = [
    { id: 3001, source: 'linkedin',   job_id: 'demo-n1', title: 'Senior Director, Strategy & Operations', company: 'Snowflake', location: 'San Mateo, CA', score: 6, score_reason: 'B2B enterprise data warehouse — outside consumer target.', salary: null, url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(9), status: 'not_fit', not_fit_reason: 'Wrong industry — pure B2B enterprise SaaS' },
    { id: 3002, source: 'ashby',      job_id: 'demo-n2', title: 'Manager, Revenue Operations',    company: 'Datadog',    location: 'New York, NY', score: 4, score_reason: 'Revenue Operations at B2B = sales focus, outside target function.', salary: null, url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(11), status: 'not_fit', not_fit_reason: 'RevOps at B2B — wrong function and industry' },
    { id: 3003, source: 'alirohde',   job_id: 'demo-n3', title: 'Chief of Staff',                  company: 'Oscar Health', location: 'New York, NY', score: 2, score_reason: 'Healthcare excluded.', salary: null, url: 'https://example.com/apply', external_url: 'https://example.com/apply', created_at: daysAgo(14), status: 'not_fit', not_fit_reason: 'Healthcare is excluded in profile' },
  ];
